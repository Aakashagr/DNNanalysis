# -*- coding: utf-8 -*-
"""
Created on Sat May 29 12:56:25 2021
...
parser.add_argument('--mode', default='lit_bias',
...
def train_bias(mode = FLAGS.mode, restore_path=None, save_path=FLAGS.save_path, plot=0, show=0):
