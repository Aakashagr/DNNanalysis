...
parser.add_argument('--wrd_path', default= 'wordsets_tel',
                    help='path to word folder that contains train and val folders')
parser.add_argument('--save_path', default='save_rep4/',
                    help='path for saving ')
parser.add_argument('--output_path', default='activations/',
                    help='path for storing activations')
parser.add_argument('--restore_file', default='save_rep4/save_pre_z_49_full_nomir.pth.tar',
