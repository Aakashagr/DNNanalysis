...
checkpoint = torch.load('save_rep4/save_lit_no_bias_z_79_full_nomir.pth.tar')['state_dict']
...
acc_nb = np.load('save_rep4/cat_scores_lit_no_bias_z_full_nomir.npy')
acc_b = np.load('save_rep4/cat_scores_lit_bias_z_full_nomir.npy')
acc_ili = np.load('save_rep4/cat_scores_pre_z_full_nomir.npy')
